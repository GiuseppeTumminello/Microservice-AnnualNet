...
class AnnualNetControllerTest {
    ...
    public void calculateAnnualNet(BigDecimal input, BigDecimal annualGross) throws Exception {
        var expected = this.objectMapper.writeValueAsString(Map.of(ANNUAL_NET_DESCRIPTION, annualGross));
